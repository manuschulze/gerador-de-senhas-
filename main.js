const numeroSenha = document.querySelector('.parametro-
senha__texto');
...
a. let numeroAleatorio = Math.random() * alfabeto.length;
b. numeroAleatorio = Math.floor(numeroAleatorio);
c. senha = senha + alfabeto[numeroAleatorio];
}
